...
class TicketData(BaseModel):
    ...
    ticket_type: str = Field(..., description="Type of ticket (Epic, Story, Task, etc.)")
    title: str = Field(..., description="Ticket title")
    description: str = Field(..., description="Ticket description")
    parent_context: Optional[str] = Field(default="", description="Parent ticket context")
...
class TreeContext(BaseModel):
    ...
    ticket_tree_structure: str = Field(..., description="String representation of ticket tree")
    ticket_descriptions: Dict[str, Any] = Field(..., description="Ticket descriptions dictionary")
...
class ExecutionPlan(BaseModel):
    ...
    continue_tests: List[str] = Field(default_factory=list, description="Tests to continue with")
...
class ExecutionDecision(BaseModel):
    ...
    affected_tests: List[str] = Field(default_factory=list, description="Tests affected by decision")
...
def create_tree_context(
    ticket_tree: Any,
    descriptions: Dict[str, Any]
) -> TreeContext:
    """Create TreeContext from ticket tree and descriptions"""
    return TreeContext(
        ticket_tree_structure=str(ticket_tree),
        ticket_descriptions=descriptions
    )
